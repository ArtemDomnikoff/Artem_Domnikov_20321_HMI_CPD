...
from Artem_Domnikov_20321_HMI_CPD.CPD.Task_6.client import order_management_pb2 as Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2
...
class OrderManagementStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addOrder = channel.unary_unary(
                ...
                request_serializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.FromString,
                )
        self.getOrder = channel.unary_unary(
                '/ecommerce.OrderManagement/getOrder',
                request_serializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.SerializeToString,
                response_deserializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.FromString,
                )
        ...
        self.processOrders = channel.stream_stream(
                ...
                request_serializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.SerializeToString,
                response_deserializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.CombinedShipment.FromString,
                )
...
def add_OrderManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'addOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.addOrder,
                    request_deserializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.FromString,
                    response_serializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.SerializeToString,
            ),
            'getOrder': grpc.unary_unary_rpc_method_handler(
                    servicer.getOrder,
                    request_deserializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.FromString,
                    response_serializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.SerializeToString,
            ),
            ...
            'processOrders': grpc.stream_stream_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_protobuf_dot_wrappers__pb2.StringValue.FromString,
                    response_serializer=Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.CombinedShipment.SerializeToString,
            ),
    }
...
class OrderManagement(object):
    ...
    def addOrder(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ecommerce.OrderManagement/addOrder',
            Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.SerializeToString,
    ...
    def getOrder(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/ecommerce.OrderManagement/getOrder',
            ...
            Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.Order.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def processOrders(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/ecommerce.OrderManagement/processOrders',
            google_dot_protobuf_dot_wrappers__pb2.StringValue.SerializeToString,
            Artem__Domnikov__20321__HMI__CPD_dot_CPD_dot_Task__6_dot_client_dot_order__management__pb2.CombinedShipment.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
