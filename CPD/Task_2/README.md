...
game() - метод для начала игры. Здесь пользователь вводит координаты для атаки.Игра длится до момента, пока не будут уничтожены все корабли на одном из полей. 
